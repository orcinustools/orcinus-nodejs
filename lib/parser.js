...
Object.keys(this.manifest.services).forEach(function(service){
    ...
    */
    ...
    if(cmd.indexOf("environment") >= 0 & app.environment.length > 0){
    ...
    */
    ...
    if(cmd.indexOf("hosts") >= 0 & app.hosts.length > 0){
    ...
    */
    ...
    if(cmd.indexOf("commands") >= 0 & app.commands.length > 0){
    ...
    */
    ...
    if(cmd.indexOf("constraints") >= 0 & app.constraints.length > 0){
    ...
    */
	if(cmd.indexOf("ports") >= 0 & app.ports.length > 0){
        endpoint.Ports = [];
    ...
    */
    ...
    if(cmd.indexOf("networks") >= 0 & app.networks.length > 0){
