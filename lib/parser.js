...
Object.keys(this.manifest.services).forEach(function(service){
    ...
    */
    ...
    if(cmd.indexOf("environment") >= 0 & app.environment.constructor == Array){
    ...
    */
    ...
    if(cmd.indexOf("hosts") >= 0 & app.hosts.constructor == Array){
    ...
    */
    ...
    if(cmd.indexOf("commands") >= 0 & app.commands.constructor == Array){
    ...
    */
    ...
    if(cmd.indexOf("labels") >= 0 & app.labels.constructor == Object){
    ...
    */
    if(cmd.indexOf("dns") >= 0 & app.dns.constructor == Object){
    ...
    */
    ...
    if(cmd.indexOf("restartPolicy") >= 0 & app.restartPolicy.constructor == Object){
    ...
    */
    ...
    if(cmd.indexOf("constraints") >= 0 & app.constraints.constructor == Array){
    ...
    */
	if(cmd.indexOf("ports") >= 0 & app.ports.constructor == Array){
        endpoint.Ports = [];
    ...
    */
    ...
    if(cmd.indexOf("networks") >= 0 & app.networks.constructor == Array){
    ...
    */
    ...
    if(cmd.indexOf("volumes") >= 0 & app.volumes.constructor == Object){
...
parser.prototype.update = function(){
    ...
    */
    ...
    if(app.environment.constructor == Array){
        container.Env = app.environment;
    }
    ...
    */
    ...
    if(app.hosts.constructor == Array){
        container.Hosts = app.hosts;
    }
    ...
    */
    ...
    if(app.commands.constructor == Array){
        container.Args = app.commands;
    }
    ...
    */
    ...
    if(app.labels.constructor == Object){
        spec.Labels = app.labels;
    }
    ...
    */
    ...
    if(app.restartPolicy.constructor == Object){
        restartPolicy = app.restartPolicy;
    }
    ...
    */
    ...
    if(app.constraints.constructor == Array){
        placement.Constraints = app.constraints;
    }
    ...
    */
    ...
    /* 
        { ports : Array[](ex-port:int-port/tcp-or-udp) } 
    */
    if(app.ports.constructor == Array){
        endpoint.Ports = [];
        app.ports.forEach(function(ports){
            var bootstrap = {
                "PublishMode": "ingress"
    ...
    */
    ...
    if(app.networks.constructor == Array){
      app.networks.forEach(function(v){
        network.push({ "Target" : v});
      });
    }
    ...
    */
    ...
    if(app.volumes.constructor == Object){
      app.volumes.forEach(function(v){
        var volume = volumes[v];
        if(volume.type == "nfs"){
            var mount = {
